...
namespace PetApp.Migrations
{
    ...
    [Migration("20250318195521_AddPhotoUrlToPet")]
    partial class AddPhotoUrlToPet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetApp.Models.Pet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Breed = "Labrador",
                            Name = "Luna",
                            PhotoUrl = "https://unsplash.com/photos/white-dog-on-sands-between-leafed-plants-O6UzDPFH36g",
                            Species = "Pies",
                            UserId = 1,
                            Weight = 25.5f
                        });
